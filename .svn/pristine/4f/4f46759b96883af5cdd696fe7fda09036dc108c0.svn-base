            ...
            <div class="contentpanel">
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-3">
                        ...
                        <h5 class="lg-title" style="text-transform: none;">Ordenar por</h5>
                        <select id="search-type" class="form-control width100p" data-placeholder="Search Type">
                            <option value="">Mejor calificadas</option>
                            <option value="Full Name">Empresas amigas</option>
                            <option value="Full Name">Productos mas recientes</option>
                        </select>

                        <div class="mb30"></div>
                        <div class="checkbox block"><label><input type="checkbox"> Solo Empresas Verificadas</label></div>
                    ...
                    <div class="col-sm-8 col-md-9">
                        ...
                        <ul class="nav nav-tabs nav-line">
                            <li class="active"><a href="#activities" data-toggle="tab"><strong>Todos</strong></a></li>
                                ...
                                <div class="activity-list">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="pull-right" style="color: gold; font-size: 16px;">
                                                <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i>
                                            </div>

                                            <div class="media blog-media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object thumbnail" src="../images/photos/media1.jpg" alt="" />
                                                </a>
                                                <div class="media-body">
                                                    <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a href="">Mostrar más</a></p>
                                                </div>
                                            </div><!-- media -->
                                        </div>
                                    </div><!-- media -->
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <strong>Dependencia de Gobierno</strong>
                                            <div class="pull-right" style="color: gold; font-size: 16px;">
                                            ...
                                            <div class="media blog-media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object thumbnail" src="../images/photos/media6.png" alt="" />
                                                </a>
                                                <div class="media-body">
                                                    <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <a href="">Mostrar más</a></p>
